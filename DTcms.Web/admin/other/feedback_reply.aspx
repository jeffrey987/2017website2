<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feedback_reply.aspx.cs" Inherits="DTcms.Web.admin.other.feedback_reply" ValidateRequest="false" %>
...
<div class="tab-content">
  <dl>
    <dt>所属站点</dt>
    <dd><%=new DTcms.BLL.channel_site().GetTitle(model.site_path)%></dd>
  </dl>
  <dl>
    <dt>联系人</dt>
