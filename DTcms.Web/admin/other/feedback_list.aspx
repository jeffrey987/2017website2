<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feedback_list.aspx.cs" Inherits="DTcms.Web.admin.other.feedback_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="feedback_reply.aspx?id=<%#Eval("id")%>"><%#Eval("title")%><%# Convert.ToInt32(Eval("is_lock")) == 1 ? "(未审核)" : ""%></a></td>
    ...
    <td align="center"><a href="feedback_reply.aspx?id=<%#Eval("id")%>">回复</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
