...
namespace DTcms.Web.admin.other
{
    public partial class feedback_list : DTcms.Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("feedback_list.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("feedback_list.aspx", "keywords={0}", txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("feedback_list.aspx", "keywords={0}", this.keywords));
        }
        ...
        protected void lbtnUnLock_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批量审核成功！", Utils.CombUrlTxt("feedback_list.aspx", "keywords={0}", this.keywords));
        }
        ...
        protected void lbtnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("feedback_list.aspx", "keywords={0}", this.keywords));
        }
